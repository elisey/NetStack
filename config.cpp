...
NpLayer np5(&RadioMacLayer, 32, 4);

NpLayer *interfaces[NUM_OF_INTERFACES] = {&np1, &np2, &np3, &np4, &np5};
...
NcmpLayerMaster ncmp5(4, &np5, interfaceType_Star);
